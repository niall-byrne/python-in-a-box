...
Consult the individual [workflow](./{{cookiecutter.project_slug}}/.github/deprecated) files to figure out what values
you
need.
...
- [Github Actions](https://docs.github.com/free-pro-team@latest/actions/reference/workflow-syntax-for-github-actions)
    - [workflows](./{{cookiecutter.project_slug}}/.github/deprecated)
- [Docker Hub](https://hub.docker.com/)
    - [release_container.yml]({{cookiecutter.project_slug}}/.github/deprecated/release_container.yml)
